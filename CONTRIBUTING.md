# Contributing to 10x PM

Help us build the definitive knowledge and task management engine for AI coding assistants! This guide shows you how to contribute new features, bug fixes, and improvements to the 10x PM platform.

## 🎯 What is 10x PM?

10x PM is a **microservices-based engine** that provides AI coding assistants with access to your documentation, project knowledge, and task management through the Model Context Protocol (MCP). The platform consists of four main services that work together to deliver comprehensive knowledge management and project automation.
...
There are a few very important rules that we ask you follow when contributing to 10x PM.
...
Make sure the crawling completes end to end, the code examples exist, and the 10x PM MCP can be used to successfully search through the documentation.
...
Test these things using both the UI and the MCP server. This process will be similar if your code changes touch the docs part of 10x PM too.

**7. If your code changes touch the MCP server instructions or anything else more high level** that could affect how AI coding assistants use the 10x PM MCP, please retest by creating a simple project from scratch that leverages 10x PM for RAG, task management, etc.
...
1. **Fork the Repository**
   - Go to https://github.com/DeepakChander/10x-Project-Management
   - Click the "Fork" button in the top right corner
   - This creates your own copy of the repository

   ```bash
   # Clone your fork from main branch for contributing (replace 'your-username' with your GitHub username)
   git clone https://github.com/your-username/10x-Project-Management.git
   cd 10x-Project-Management

   # Add upstream remote to sync with main repository later
   git remote add upstream https://github.com/DeepakChander/10x-Project-Management.git
   ```

   **Note:** The `main` branch is used for contributions and contains the latest development work. The `stable` branch is for users who want a more tested, stable version of 10x PM.

2. **🤖 AI Coding Assistant Setup**

   **IMPORTANT**: If you're using AI coding assistants to help contribute to 10x PM, set up our global rules for optimal results.
   ...
   These rules contain essential context about 10x PM's architecture, service patterns, MCP implementation, and development best practices. Using them will help your AI assistant follow our conventions and implement features correctly.
...
2. **Create Pull Request via GitHub UI**
   - Go to your fork on GitHub (https://github.com/your-username/10x-Project-Management)
...
2. **UI Design Standards**
   ...
   - **UI Consistency Review**: Run `/10x:ui-consistency-review <path>` to automatically check your components for compliance
...
**Ready to contribute?** Start by exploring the codebase, reading the architecture documentation, and finding an area that interests you. Every contribution makes 10x PM better for the entire AI development community.
