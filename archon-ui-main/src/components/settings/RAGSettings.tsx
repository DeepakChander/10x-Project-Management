...
const colorStyles: Record<ProviderKey, string> = {
  ...
  openrouter: 'border-[#C0745F] bg-[#C0745F]/10',
  ollama: 'border-[#C0745F] bg-[#C0745F]/10',
  ...
  return <Card accentColor="green" className="overflow-hidden p-8">
        ...
        <div className="flex gap-4 mb-6">
          ...
          <GlowButton
            ...
            variant="ghost"
            className={`min-w-[180px] px-5 py-3 font-semibold text-white dark:text-white
              border border-[#C0745F]/70 dark:border-[#C0745F]/40
              bg-black/40 backdrop-blur-md
              shadow-[inset_0_0_16px_rgba(192,116,95,0.38)]
              hover:bg-[#C0745F]/12 dark:hover:bg-[#C0745F]/20
              hover:border-[#C0745F]/80 hover:shadow-[0_0_24px_rgba(192,116,95,0.52)]
              ${(activeSelection === 'embedding')
                ? 'shadow-[0_0_26px_rgba(192,116,95,0.55)] ring-2 ring-[#C0745F]/60'
                : 'shadow-[0_0_15px_rgba(192,116,95,0.25)]'}
            `}
          >
            <span className="flex items-center justify-center gap-2">
              <PiDatabaseThin className="w-4 h-4 text-[#C0745F]" aria-hidden="true" />
            ...
            <div className="flex-1 max-w-md">
              {activeSelection === 'chat' ? (
                ...
                embeddingProvider !== 'ollama' ? (
                  ...
                  <div className="p-3 border border-[#C0745F]/30 rounded-lg bg-[#C0745F]/5">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                      Embedding Model
                    </label>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="text-xs text-[#C0745F] mt-1">
                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            className="text-[#C0745F] border-[#C0745F] hover:bg-[#C0745F]/10"
                      ...
                      <tr>
                        ...
                        <td className="py-2">
                          {ollamaMetrics.loading ? (
                            ...
                            <div className="text-white">
                              <span className="text-[#C0745F] font-medium text-lg">{ollamaMetrics.embeddingInstanceModels?.embedding || 0}</span>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2 mt-3">
                  <input
                    ...
                    className="w-4 h-4 text-[#C0745F] bg-gray-100 border-gray-300 rounded focus:ring-[#C0745F] dark:focus:ring-[#C0745F] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
