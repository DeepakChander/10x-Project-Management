              ...
              <div className="flex-1 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  {instance.instanceType && instance.instanceType !== 'both' && (
                    <Badge 
                      variant="solid" 
                      color={instance.instanceType === 'chat' ? 'blue' : 'orange'}
                      className="text-xs"
                    >
      ...
      {separateHosts && (selectedChatModel || selectedEmbeddingModel) && (
        <Card className="p-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {selectedEmbeddingModel && (
              <div className="flex items-center justify-between p-3 bg-[#C0745F]/10 dark:bg-[#C0745F]/10 rounded">
                <div>
                  <div className="font-medium text-[#C0745F] dark:text-[#C0745F]">
                    Embedding Model
                  </div>
                  <div className="text-sm text-[#C0745F]/80 dark:text-[#C0745F]/80">
                    {selectedEmbeddingModel}
                  </div>
                </div>
