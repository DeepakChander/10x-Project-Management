  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Settings className="w-7 h-7 text-[#C0745F] filter drop-shadow-[0_0_4px_rgba(192,116,95,0.4)]" />
          Settings
        </motion.h1>
      </motion.div>
            ...
            >
              <div className="space-y-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Found a bug or issue? Report it to help improve 10x Beta.
                </p>
      ...
      <motion.div variants={itemVariants} className="mt-12 flex justify-center">
        <button
          ...
          className="relative w-8 h-8 rounded-full border border-[#C0745F]/30 bg-[#C0745F]/5 hover:bg-[#C0745F]/8 transition-all duration-200 flex items-center justify-center group"
          title="Toggle Button Playground"
        >
          <div className="absolute inset-0 rounded-full bg-[#C0745F]/10 blur-sm opacity-0 group-hover:opacity-100 transition-opacity" />
          <motion.div
            animate={{ rotate: showButtonPlayground ? 180 : 0 }}
            transition={{ duration: 0.2 }}
          >
            <ChevronDown className="w-4 h-4 text-[#C0745F]/50" />
          </motion.div>
        </button>
      </motion.div>
