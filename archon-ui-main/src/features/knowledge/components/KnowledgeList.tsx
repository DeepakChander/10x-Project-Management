    ...
    return (
      ...
      >
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#C0745F]/10 dark:bg-[#C0745F]/10 mb-4">
            <AlertCircle className="w-6 h-6 text-[#C0745F]" />
          </div>
