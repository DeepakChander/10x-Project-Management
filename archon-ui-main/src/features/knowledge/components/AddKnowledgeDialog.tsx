        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "crawl" | "upload")}>
          ...
          <TabsContent value="crawl" className="space-y-6 mt-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Globe className="h-5 w-5" style={{ color: "#C0745F" }} />
                </div>
                <Input
                  id={urlId}
                  type="url"
                  ...
                  className={cn(
                    ...
                    "border-gray-300/60 dark:border-gray-600/60 focus:border-[#C0745F]/70",
                  )}
                />
              </div>
            </div>
            ...
            <Button
              ...
              className={[
                "w-full bg-gradient-to-r from-[#C0745F] to-[#A85A45]",
                "hover:from-[#A85A45] hover:to-[#8E4A38]",
                "backdrop-blur-md border border-[#C0745F]/50",
              ...
              <div className="relative">
                ...
                <div
                  className={cn(
                    ...
                    selectedFile ? "border-[#C0745F]/70" : "border-gray-300/60 dark:border-gray-600/60",
                    !selectedFile && "hover:border-[#C0745F]/50",
                    isProcessing && "opacity-50 cursor-not-allowed",
                  )}
                >
                  <Upload
                    className={cn("w-6 h-6", selectedFile ? "text-[#C0745F]" : "text-gray-400 dark:text-gray-500")}
                  />
                  <div className="text-sm">
                    {selectedFile ? (
                      <div className="space-y-1">
                        <p className="font-medium text-[#C0745F] dark:text-[#D4917A]">{selectedFile.name}</p>
                        <p className="text-xs text-[#C0745F] dark:text-[#D4917A]">
