      ...
      {!isEditing && hasMoreTags && (
        <button
          ...
          className={[
            ...
            "hover:text-[#C0745F] dark:hover:text-[#D4917A] transition-colors px-1 py-0.5 rounded",
          ].join(" ")}
        >
          {showAllTags ? (
            <>
        ...
        <div className="flex items-center gap-1">
          <Input
            ...
            className={cn(
              ...
              "border-[#C0745F] dark:border-[#C0745F]",
              "focus:ring-1 focus:ring-[#C0745F]",
            )}
            disabled={updateMutation.isPending}
          />
          <button
            ...
            className="text-[#C0745F] hover:text-[#A85A45] dark:text-[#D4917A] dark:hover:text-[#C0745F]"
        ...
        <SimpleTooltip content="Click to add or edit tags">
          <button
            ...
            className={[
              ...
              "hover:text-[#C0745F] dark:hover:text-[#D4917A] hover:border-[#C0745F] dark:hover:border-[#C0745F]",
              "transition-colors",
            ].join(" ")}
            aria-label="Add tags"
          >
      ...
      {isEditing && (
        <div className="flex items-center gap-1 ml-2">
          <button
            ...
            disabled={updateMutation.isPending}
            className={[
              "px-2 py-1 text-xs bg-[#C0745F] dark:bg-[#C0745F] text-white",
              "hover:bg-[#A85A45] dark:hover:bg-[#A85A45] disabled:opacity-50 transition-colors",
            ].join(" ")}
          >
            Save
          </button>
