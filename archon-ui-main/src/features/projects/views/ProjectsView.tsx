...
const SidebarProjectCard: React.FC<SidebarProjectCardProps> = ({ project, isSelected, taskCounts, onSelect }) => {
  ...
  const getBackgroundClass = () => {
    if (project.pinned)
      return "bg-gradient-to-b from-[#C0745F]/10 via-[#C0745F]/5 to-[#C0745F]/8 dark:from-[#C0745F]/15 dark:via-[#C0745F]/10 dark:to-[#C0745F]/5";
    if (isSelected)
      return "bg-gradient-to-b from-white/70 via-[#C0745F]/5 to-white/50 dark:from-white/5 dark:via-[#C0745F]/5 dark:to-black/20";
  ...
  return (
    <SelectableCard
      ...
      size="none"
      blur="md"
      className={cn("p-2", getBackgroundClass(), optimistic && "opacity-80 ring-1 ring-[#C0745F]/30")}
    >
      <div className="space-y-2">
        {/* Title */}
        <div className="flex items-center justify-between">
          <h4
            className={cn(
              ...
              isSelected ? "text-[#C0745F] dark:text-[#D4917A]" : "text-gray-700 dark:text-gray-300",
            )}
          >
            {project.title}
          </h4>
          <div className="flex items-center gap-1">
            {project.pinned && (
              <div
                className="flex items-center gap-1 px-1.5 py-0.5 bg-[#C0745F] dark:bg-[#A85A45] text-white text-[9px] font-bold rounded-full"
                aria-label="Pinned"
              >
