        ...
        <div className="markdown-content">
          <ReactMarkdown
            components={{
              ...
              code: ({ node, ...props }) => (
                <code
                  className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-xs font-mono text-[#C0745F] dark:text-[#D4917A]"
                  {...props}
                />
              ),
              pre: ({ node, ...props }) => (
              ...
              a: ({ node, ...props }) => <a className="text-[#C0745F] dark:text-[#D4917A] hover:underline" {...props} />,
        ...
        <div className="space-y-6">
          {document.content.sections.map((section: any, index: number) => (
            <div key={index} className="space-y-2">
              {section.heading && (
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white border-l-4 border-[#C0745F] pl-3">
                  {section.heading}
                </h3>
              )}
              {section.content && (
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mt-1">
              <span className="text-sm text-gray-600 dark:text-gray-400">
                Type:{" "}
                <span className="px-2 py-1 text-xs bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] rounded">
        ...
        {isEditMode ? (
          <textarea
            ...
            className={cn(
              ...
              "focus:outline-none focus:border-[#C0745F] focus:ring-2 focus:ring-[#C0745F]/20",
              "resize-y",
            )}
