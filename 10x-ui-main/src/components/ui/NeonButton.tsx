  ...
  const getColorConfig = (color: ColorOption) => {
    const configs = {
      ...
      purple: {
        ...
        glow: 'rgba(192,116,95,0.6)',
        glowDark: 'rgba(192,116,95,0.5)',
        aurora: 'rgba(192,116,95,0.8)',
        auroraDark: 'rgba(192,116,95,0.6)',
        text: 'rgb(192 116 95)', // copper
        textRgb: '192, 116, 95'
      },
      pink: {
          ...
          <div
            className={cn(
              ...
              layer2Color === 'none' 
                ...
                : layer2Color === 'purple'
                  ? 'bg-gradient-to-b from-[#C0745F]/30 to-[#C0745F]/30'
                  : layer2Color === 'pink'
