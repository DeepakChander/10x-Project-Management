...
export const Button: React.FC<ButtonProps> = ({
  ...
  const neonLineColor = {
    ...
    blue: 'bg-blue-500 shadow-[0_0_10px_2px_rgba(192,116,95,0.4)] dark:shadow-[0_0_20px_5px_rgba(192,116,95,0.7)]',
    cyan: 'bg-[#C0745F] shadow-[0_0_10px_2px_rgba(192,116,95,0.4)] dark:shadow-[0_0_20px_5px_rgba(192,116,95,0.7)]',
  ...
  return <button className={`
      ...
      {variant === 'primary' && <>
        ...
        background: `radial-gradient(circle, ${accentColor === 'green' ? 'rgba(16, 185, 129, 0.9)' : accentColor === 'blue' ? 'rgba(192, 116, 95, 0.9)' : accentColor === 'pink' ? 'rgba(236, 72, 153, 0.9)' : accentColor === 'cyan' ? 'rgba(192, 116, 95, 0.9)' : accentColor === 'orange' ? 'rgba(249, 115, 22, 0.9)' : 'rgba(192, 116, 95, 0.9)'} 0%, transparent 70%)`,
        filter: `drop-shadow(0 0 15px ${accentColor === 'green' ? 'rgba(16, 185, 129, 0.8)' : accentColor === 'blue' ? 'rgba(192, 116, 95, 0.8)' : accentColor === 'pink' ? 'rgba(236, 72, 153, 0.8)' : accentColor === 'cyan' ? 'rgba(192, 116, 95, 0.8)' : accentColor === 'orange' ? 'rgba(249, 115, 22, 0.8)' : 'rgba(192, 116, 95, 0.8)'})`
      }} aria-hidden="true" />
        ...
        boxShadow: `0 0 20px 5px ${accentColor === 'green' ? 'rgba(16, 185, 129, 0.6)' : accentColor === 'blue' ? 'rgba(192, 116, 95, 0.6)' : accentColor === 'pink' ? 'rgba(236, 72, 153, 0.6)' : accentColor === 'cyan' ? 'rgba(192, 116, 95, 0.6)' : accentColor === 'orange' ? 'rgba(249, 115, 22, 0.6)' : 'rgba(192, 116, 95, 0.6)'}`
      }} aria-hidden="true" />
        </>}
