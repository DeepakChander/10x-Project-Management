...
export const Input: React.FC<InputProps> = ({
  ...
  const accentColorMap = {
    purple: 'focus-within:border-[#C0745F] focus-within:shadow-[0_0_15px_rgba(192,116,95,0.5)]',
    ...
    blue: 'focus-within:border-blue-500 focus-within:shadow-[0_0_15px_rgba(192,116,95,0.5)]'
  };
