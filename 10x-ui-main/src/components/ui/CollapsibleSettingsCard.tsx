...
export const CollapsibleSettingsCard: React.FC<CollapsibleSettingsCardProps> = ({
  ...
  const iconColorMap = {
    purple: 'text-[#C0745F] filter drop-shadow-[0_0_4px_rgba(192,116,95,0.3)]',
    ...
    blue: 'text-blue-500 filter drop-shadow-[0_0_8px_rgba(192,116,95,0.8)]',
    cyan: 'text-[#C0745F] filter drop-shadow-[0_0_4px_rgba(192,116,95,0.3)]',
