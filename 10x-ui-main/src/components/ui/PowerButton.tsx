...
export const PowerButton: React.FC<PowerButtonProps> = ({
  ...
  const colorMap = {
    purple: {
      border: 'border-[#C0745F]',
      glow: 'shadow-[0_0_15px_rgba(192,116,95,0.8)]',
      glowHover: 'hover:shadow-[0_0_25px_rgba(192,116,95,1)]',
      fill: 'bg-[#C0745F]',
      innerGlow: 'shadow-[inset_0_0_10px_rgba(192,116,95,0.8)]'
    },
    green: {
