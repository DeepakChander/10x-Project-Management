...
export const Card: React.FC<CardProps> = ({
  ...
  const accentColorMap = {
    purple: {
      glow: 'before:shadow-[0_0_10px_2px_rgba(192,116,95,0.4)] dark:before:shadow-[0_0_20px_5px_rgba(192,116,95,0.7)]',
      line: 'before:bg-[#C0745F]',
      border: 'border-[#C0745F]/30 dark:border-[#C0745F]/30',
      gradientFrom: 'from-[#C0745F]/10 dark:from-[#C0745F]/20',
      gradientTo: 'to-white dark:to-[#C0745F]/5'
    },
    green: {
