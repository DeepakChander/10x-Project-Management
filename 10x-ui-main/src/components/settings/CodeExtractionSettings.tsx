      ...
      <div className="relative flex items-center h-5 mt-1">
        ...
        <label 
          ...
          className="relative w-5 h-5 rounded-md transition-all duration-200 cursor-pointer
            ...
            peer-checked:border-[#C0745F] dark:peer-checked:border-[#C0745F]/50
            peer-checked:bg-gradient-to-b peer-checked:from-[#C0745F]/20 peer-checked:to-[#C0745F]/20
            group-hover:border-[#C0745F]/50 dark:group-hover:border-[#C0745F]/30
            peer-checked:shadow-sm"
        >
          <Check className={`
              w-3.5 h-3.5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
              transition-all duration-200 text-[#C0745F] pointer-events-none
