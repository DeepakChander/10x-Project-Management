          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-4 flex-1">
              ...
              <p className="text-red-200">
                The 10x backend service failed to start. This is typically due to a configuration issue.
              </p>
              ...
              <div className="bg-black/50 rounded-lg p-4 border border-red-900/50">
                ...
                <p className="text-red-100 font-mono text-sm mb-3">
                  Check the <span className="text-red-400 font-bold">10x API server</span> container logs in Docker Desktop for detailed error information.
                </p>
