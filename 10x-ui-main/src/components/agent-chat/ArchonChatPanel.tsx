...
/**
 * ArchonChatPanel - A chat interface for the 10x AI assistant
 *
    ...
    <div ref={chatPanelRef} className="h-full flex flex-col relative" style={{
      ...
      <div className="h-full flex flex-col relative backdrop-blur-md bg-gradient-to-b from-white/80 to-white/60 dark:from-white/10 dark:to-black/30 border-l border-blue-200 dark:border-blue-500/30">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-zinc-800/80">
          <div className="flex flex-col gap-2">
            <div className="flex items-center">
              {/* 10x Logo - No animation in header */}
              <div className="relative w-8 h-8 mr-3 flex items-center justify-center">
                <img src="/logo-10x.png" alt="10x" className="w-6 h-6 z-10 relative" />
              </div>
          ...
          {messages.map(message => (
            <div key={message.id} className={`flex ${message.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
              <div className={`
                ...
                ${message.sender === 'user'
                  ? 'bg-[#C0745F]/10 dark:bg-[#C0745F]/20 border border-[#C0745F]/20 dark:border-[#C0745F]/30 ml-auto'
                  : 'bg-blue-100/80 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30 mr-auto'}
              `}>
                <div className="flex items-center mb-1">
                  {message.sender === 'agent' ? (
                    <div className="w-4 h-4 mr-1 flex items-center justify-center">
                      <img src="/logo-10x.png" alt="10x" className="w-full h-full" />
                    </div>
                  ) : (
                    <User className="w-4 h-4 text-[#C0745F] mr-1" />
                  )}
        ...
        <div className="p-4 border-t border-gray-200 dark:border-zinc-800/80 bg-white/60 dark:bg-transparent">
          ...
          <div className="flex items-center gap-2">
            {/* Text input field */}
            <div className="flex-1 backdrop-blur-md bg-gradient-to-b from-white/80 to-white/60 dark:from-white/10 dark:to-black/30 border border-gray-200 dark:border-zinc-800/80 rounded-md px-3 py-2 focus-within:border-blue-500 focus-within:shadow-[0_0_15px_rgba(192,116,95,0.5)] transition-all duration-200">
              <input 
                type="text" 
                value={inputValue} 
            ...
            >
              ...
              } shadow-[0_0_10px_rgba(192,116,95,0.3),inset_0_0_6px_rgba(192,116,95,0.2)] dark:shadow-[0_0_10px_rgba(192,116,95,0.6),inset_0_0_6px_rgba(192,116,95,0.4)] transition-all duration-300`}></div>
              {/* Inner glow effect */}
              ...
              } drop-shadow-[0_0_3px_rgba(192,116,95,0.5)] dark:drop-shadow-[0_0_3px_rgba(192,116,95,0.8)] transition-all duration-200`} />
              {/* Shine effect */}
