        ...
        <Popover.Trigger asChild>
          <Button
            ...
            className={cn(
              ...
              "focus:outline-none focus:ring-1 focus:ring-[#C0745F]",
        ...
        <Popover.Portal>
          <Popover.Content
            className={cn(
              ...
              "shadow-stone-500/10 dark:shadow-stone-400/10",
              "z-50",
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isSelected && "bg-[#C0745F]/10 dark:bg-[#C0745F]/10",
                        ...
                        >
                          <Check
                            className={cn(
                              ...
                              isSelected ? "opacity-100 text-[#C0745F] dark:text-[#D4907D]" : "opacity-0",
                            )}
                            aria-hidden="true"
                          />
                    ...
                    {hasCustomOption && (
                      <button
                        ...
                        className={cn(
                          "relative flex w-full items-center px-2 py-1.5",
                          "text-xs text-left",
                          "bg-[#C0745F]/10 dark:bg-[#C0745F]/10",
                          "text-[#C0745F] dark:text-[#D4907D]",
                          "border-t border-gray-200/50 dark:border-gray-700/50",
                          "hover:bg-[#C0745F]/15 dark:hover:bg-[#C0745F]/15",
                          "transition-colors duration-200",
                          highlightedIndex === filteredOptions.length && "bg-[#C0745F]/15 dark:bg-[#C0745F]/15",
                        )}
                      >
