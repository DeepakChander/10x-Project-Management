...
export const PillNavigation = ({
  ...
  const getColorClasses = (variant: string, isSelected: boolean) => {
    const colors = {
      blue: isSelected
        ? "bg-[#5B8C5A]/10 dark:bg-[#5B8C5A]/15 text-[#5B8C5A] dark:text-[#7DAC7C] border border-[#5B8C5A]/40"
        : "text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/5",
      orange: isSelected
        ? "bg-orange-500/10 dark:bg-orange-400/15 text-orange-700 dark:text-orange-300 border border-orange-400/40"
        : "text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/5",
      cyan: isSelected
        ? "bg-[#C0745F]/10 dark:bg-[#C0745F]/15 text-[#C0745F] dark:text-[#D4907D] border border-[#C0745F]/40"
        : "text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/5",
      purple: isSelected
        ? "bg-amber-500/10 dark:bg-amber-400/15 text-amber-700 dark:text-amber-300 border border-amber-400/40"
        : "text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/5",
      green: isSelected
        ? "bg-green-500/10 dark:bg-green-400/15 text-green-700 dark:text-green-300 border border-green-400/40"
        : "text-gray-700 dark:text-gray-300 hover:bg-white/10 dark:hover:bg-white/5",
    };
