        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-700">
            <div className="flex items-center gap-3">
              <Database className="w-6 h-6 text-[#C0745F]" />
          ...
          {/* Instructions */}
          <div className="p-6 bg-[#C0745F]/10 border-b border-gray-700">
            <h3 className="text-[#C0745F] font-medium mb-2 flex items-center gap-2">
            ...
            {migrations.length > 1 && (
              <button
                ...
                className="mt-3 px-3 py-1.5 bg-[#C0745F]/10 hover:bg-[#C0745F]/20 border border-[#C0745F]/50 rounded text-[#C0745F] text-sm font-medium transition-colors"
              >
                Copy All Migrations
              </button>
            )}
          ...
          <div className="p-6 border-t border-gray-700 flex justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#C0745F]/10 hover:bg-[#C0745F]/20 border border-[#C0745F]/50 rounded-lg text-[#C0745F] font-medium transition-colors"
            >
              Refresh Status
            </button>
          </div>
