...
export const InspectorSidebar: React.FC<InspectorSidebarProps> = ({
  ...
  return (
    <aside className="w-80 border-r border-border flex flex-col bg-muted" aria-label="Document and code browser">
      {/* Search */}
            ...
            {items.map((item) => (
              <motion.button
                ...
                className={cn(
                  ...
                  "hover:bg-white/5 dark:hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-[#C0745F]/50",
                  selectedItemId === item.id
                    ? "bg-[#C0745F]/10 dark:bg-[#C0745F]/10 border border-[#C0745F]/30 dark:border-[#C0745F]/30 ring-1 ring-[#C0745F]/20"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="mt-0.5 flex-shrink-0" aria-hidden="true">
                    {viewMode === "documents" ? (
                      <FileText className="w-4 h-4 text-[#C0745F]" />
                    ) : (
            ...
            {hasNextPage && !isLoading && (
              <div className="p-3 mt-2">
                <Button
                  ...
                  className="w-full text-[#C0745F] dark:text-[#D4917A] hover:text-white dark:hover:text-white hover:bg-[#C0745F]/10 transition-all"
