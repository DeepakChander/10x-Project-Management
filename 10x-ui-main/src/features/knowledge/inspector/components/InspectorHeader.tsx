          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span
              className={cn(
                ...
                item.source_type === "url"
                  ? "bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] border border-[#C0745F]/20"
                  : "bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] border border-[#C0745F]/20",
              )}
            >
              {item.source_type === "url" ? (
            ...
            {item.url && (
              <a
                ...
                className="text-xs text-[#C0745F] hover:text-[#A85A45] truncate max-w-xs"
              >
                {item.url}
              </a>
            )}
