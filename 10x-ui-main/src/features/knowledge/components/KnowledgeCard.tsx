    ...
    >
      <DataCard
        ...
        className={cn(
          "transition-shadow",
          isHovered && "shadow-md",
          optimistic && "ring-1 ring-[#C0745F]/30",
        )}
      >
        <DataCardHeader>
              ...
              <SimpleTooltip content={isUrl ? "Content from a web page" : "Uploaded document"}>
                <div
                  className={cn(
                    ...
                    isUrl
                      ? "bg-[#C0745F]/10 text-[#C0745F] dark:bg-[#C0745F]/10 dark:text-[#D4917A]"
                      : "bg-[#C0745F]/10 text-[#C0745F] dark:bg-[#C0745F]/10 dark:text-[#D4917A]",
                  )}
                >
                  {getSourceIcon()}
            ...
            (isUrl ? (
              <a
                ...
                className={[
                  ...
                  "text-gray-600 dark:text-gray-400 hover:text-[#C0745F] dark:hover:text-[#D4917A] transition-colors",
                ].join(" ")}
              >
