      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <TooltipTrigger asChild>
            <button
              type="button"
              className="text-gray-400 hover:text-[#C0745F] transition-colors cursor-help"
              ...
              <SimpleTooltip content={level.details}>
                <button
                  ...
                  className={cn(
                    ...
                    glassCard.base,
                    "focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C0745F] focus-visible:ring-offset-2",
                    ...
                    !disabled && !isSelected && "hover:border-[#C0745F]/50",
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isSelected ? "text-[#C0745F] dark:text-[#D4917A]" : "text-gray-500 dark:text-gray-400",
                    )}
                  >
