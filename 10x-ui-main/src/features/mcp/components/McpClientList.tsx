  ...
  if (clients.length === 0) {
    return (
      <div className={cn(compoundStyles.card, "p-6 text-center rounded-lg relative overflow-hidden", className)}>
        <div className="absolute top-3 right-3 px-2 py-1 bg-[#C0745F]/10 text-[#C0745F] text-xs font-semibold rounded-full border border-[#C0745F]/30">
          Coming Soon
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-4 text-sm">
            <div className="flex items-center gap-1">
              <Clock className="w-3 h-3 text-[#C0745F]" />
