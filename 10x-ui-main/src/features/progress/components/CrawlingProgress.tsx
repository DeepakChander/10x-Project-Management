...
export const CrawlingProgress: React.FC<CrawlingProgressProps> = ({ onSwitchToBrowse }) => {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      default:
        return <Loader2 className="w-4 h-4 text-[#C0745F] animate-spin" />;
    }
  };
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default:
        return "text-[#C0745F] bg-[#C0745F]/10 border-[#C0745F]/20";
    }
  };
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#C0745F]/10 mb-4">
            <Globe className="w-6 h-6 text-[#C0745F]" />
          </div>
            ...
            >
              <div
                className={cn(
                  ...
                  "bg-muted backdrop-blur-sm border-border",
                  isActive && "border-[#C0745F]/30 shadow-sm",
                )}
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  {isActive && (
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-[#C0745F] font-medium">{progress}%</span>
                      </div>
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className="h-full bg-[#C0745F] transition-all duration-300"
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-2">
                    {(operation.pages_crawled !== undefined || operation.stats?.pages_crawled !== undefined) && (
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#C0745F]">
