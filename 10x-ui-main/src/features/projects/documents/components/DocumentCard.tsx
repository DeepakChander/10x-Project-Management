...
const getTypeColor = (type?: DocumentType) => {
  switch (type) {
    case "prp":
      return { badge: "bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] border-[#C0745F]/30", glow: "blue" };
    case "technical":
      return { badge: "bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/30", glow: "green" };
    case "business":
      return { badge: "bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] border-[#C0745F]/30", glow: "purple" };
    case "meeting_notes":
      return { badge: "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/30", glow: "orange" };
    case "spec":
      return { badge: "bg-[#C0745F]/10 text-[#C0745F] dark:text-[#D4917A] border-[#C0745F]/30", glow: "cyan" };
    case "design":
    ...
    case "guide":
      return { badge: "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/30", glow: "orange" };
    default:
      return { badge: "bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-500/30", glow: "blue" };
  }
};
