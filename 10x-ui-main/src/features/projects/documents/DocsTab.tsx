...
export const DocsTab = ({ project }: DocsTabProps) => {
  ...
  const handleAddDocument = async (title: string, document_type: string) => {
    await createDocumentMutation.mutateAsync({
      ...
      // NOTE: 10x does not have user authentication - this is a single-user local app.
      // "User" is a constant representing the sole user of this 10x instance.
      author: "User",
    });
  };
      ...
      <div className="w-64 flex flex-col space-y-4 overflow-visible">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="text-[#C0745F] dark:text-[#D4917A] hover:bg-[#C0745F]/10"
