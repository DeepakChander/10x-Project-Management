  ...
  return (
    <SelectableCard
      ...
      className={cn(
        ...
        project.pinned
          ? "bg-gradient-to-b from-[#C0745F]/10 via-[#C0745F]/5 to-[#C0745F]/10 dark:from-[#C0745F]/20 dark:via-[#C0745F]/10 dark:to-[#C0745F]/5"
          : isSelected
            ? "bg-gradient-to-b from-white/70 via-[#C0745F]/5 to-white/50 dark:from-white/5 dark:via-[#C0745F]/5 dark:to-black/20"
            : "bg-gradient-to-b from-white/80 to-white/60 dark:from-white/10 dark:to-black/30",
        optimistic && "opacity-80 ring-1 ring-[#C0745F]/30",
      )}
    >
      ...
      <div className="flex-1 p-4 pb-2">
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-2 w-full">
          ...
          <div className="relative flex-1">
            <div
              className={cn(
                "absolute inset-0 bg-[#C0745F] rounded-full blur-md",
                isSelected ? "opacity-30 dark:opacity-75" : "opacity-0",
              )}
            ></div>
            <div
              className={cn(
                "relative flex items-center h-12 backdrop-blur-sm rounded-full border shadow-sm transition-all duration-300",
                isSelected
                  ? "bg-white/70 dark:bg-zinc-900/90 border-[#C0745F] dark:border-[#C0745F]/50 dark:shadow-sm hover:shadow-md"
                  : "bg-white/30 dark:bg-zinc-900/30 border-gray-300/50 dark:border-gray-700/50",
              )}
            >
              <div className="flex flex-col items-center justify-center px-2 min-w-[40px]">
                <Activity
                  className={cn(
                    "w-4 h-4",
                    isSelected ? "text-[#C0745F] dark:text-[#D4917A]" : "text-gray-500 dark:text-gray-600",
                  )}
                />
                <span
                  className={cn(
              ...
              <div
                className={cn(
                  "flex-1 flex items-center justify-center border-l",
                  isSelected ? "border-[#C0745F]/50 dark:border-[#C0745F]/30" : "border-gray-300/50 dark:border-gray-700/50",
                )}
              >
                <span
                  className={cn(
      ...
      <div className="flex items-center justify-between px-3 py-2 mt-auto border-t border-gray-200/30 dark:border-gray-700/20">
        ...
        {project.pinned ? (
          <div className="px-2 py-0.5 bg-[#C0745F] dark:bg-[#A85A45] text-white text-[10px] font-bold rounded-full shadow-sm">
            DEFAULT
          </div>
        ) : (
          <div></div>
