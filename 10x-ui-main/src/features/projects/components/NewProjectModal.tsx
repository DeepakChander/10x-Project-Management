    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle className="text-xl font-bold bg-gradient-to-r from-[#C0745F] to-[#A85A45] text-transparent bg-clip-text">
              Create New Project
            </DialogTitle>
          ...
          <div className="space-y-4 my-6">
            <div>
              ...
              <Input
                ...
                className={cn("w-full", "focus:border-[#C0745F] focus:shadow-sm")}
                autoFocus
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className={cn(
                  ...
                  "focus:outline-none focus:border-[#C0745F]",
                  "focus:shadow-sm",
