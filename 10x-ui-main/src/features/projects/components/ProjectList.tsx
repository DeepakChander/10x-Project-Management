...
interface ProjectListProps {
  ...
  taskCounts: Record<string, { backlog: number; todo: number; doing: number; review: number; done: number }>;
  isLoading: boolean;
  error: Error | null;
      ...
      <motion.div initial="hidden" animate="visible" variants={itemVariants} className="mb-10">
        <div className="flex items-center justify-center py-12">
          <div className="text-center" aria-live="polite" aria-busy="true">
            <Loader2 className="w-8 h-8 text-[#C0745F] mx-auto mb-4 animate-spin" />
